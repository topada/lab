...
Go to the MongoDB Community Server `download page`_ and select the current version, OS ``RHEL 7.0 Linux 64-bit x64`` (RedHat / CentOS 7.0), package ``TGZ``. Copy the download link and use ``wget`` to download it to your Uberspace:
